	...
	if request.method == "POST":
		...
		if data:
			if values['userProfilePicture'] != None:
				...
				newpath = "C:\Users\Admin\Pictures\Saved Pictures\s1.jpg"+filename
				shutil.move("imageToSave.jpg","C:\Users\Admin\Pictures\Saved Pictures\s1.jpg")
				os.rename("C:\Users\Admin\Pictures\Saved Pictures\s1.jpg", newpath)
	...
	if request.method == "POST":
		...
		if data:
			...
			if values['driverLicPicture'] != None:
				...
				newpath1 = "C:\Users\Admin\Pictures\Saved Pictures\s1.jpg"+filename1
				shutil.move("imageToSave.jpg","C:\Users\Admin\Pictures\Saved Pictures\s1.jpg")
				os.rename("C:\Users\Admin\Pictures\Saved Pictures\s1.jpg", newpath1)
